...
# set hardcoded stuff for REG in FB15K-237
task="regression"
task_names="date_of_birth,film_rating,film_release_date,latitude,longitude,node_importance_1,org_date_founded,person_height,population_number,size_area"
